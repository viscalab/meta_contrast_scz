...
tabl_dem_clin_par <- tabl_raw |> 
  ...
  align = "center"
    ...
    tab_footnote(
    footnote = "2IFC: Two-interval forced choice; 2AFC: Spatial two-alternative forced choice",
...
gtsave(tabl_dem_clin_par, "figures/paper/table_dem_clin_par.png", 
       vwidth = 2300, vheight = 800)
```
