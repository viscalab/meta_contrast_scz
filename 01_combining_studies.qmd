...
```{r}
studies_long <- list(schwartz_1985_long, 
                     schwartz_1987_long, 
...
## Spatial frequency not available 

For some studies, for some reason the spatil frequency was not available
...
ggsave("figures/paper/sup/p_cs.pdf", 
       p_cs, 
       width = 7.2,
       height = 13.5)

ggsave("figures/paper/sup/p_cs.png", 
       p_cs, 
       width = 7.2,
       height = 13.5)
```
...
ggsave("figures/paper/sup/p_es.pdf", 
       p_es, 
       width = 7.5,
       height = 11.5)

ggsave("figures/paper/sup/p_es.png", 
       p_es, 
       width = 7.5,
       height = 11.5)
```
...
p_stim <- ggdraw() + draw_image(x = 0, y = -0.1, 
                                            scale = .85,
